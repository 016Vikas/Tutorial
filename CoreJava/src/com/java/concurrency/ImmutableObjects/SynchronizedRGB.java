package com.java.concurrency.ImmutableObjects;

/*
 * The class, SynchronizedRGB, defines objects that represent colors. Each object represents the color 
 * as three integers that stand for primary color values and a string that gives the name of the color.
 */
