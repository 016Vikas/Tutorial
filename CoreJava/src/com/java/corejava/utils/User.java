...
public class User implements Externalizable {
    ...
    /*
     * This helps the de-serialization process keeps re-constructing the objects correctly 
     * when the serializable classes get changed overtime, and avoid the InvalidClassException.
     */
    // attributes
    private int code;
    private String name;
